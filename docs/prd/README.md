...
- [**v1.1 — Comparison**](v1.1-comparison.md) — cross-goal contention: a Goal may
  ...
  each goal costs the others in months. Issue #153, **not yet shipped**.
...
- **Cross-goal interaction** — the v1 PRD's v1.2 — is planned and specified, as
  **v1.1** above. It was rewritten against the rebuilt four-way engine rather
  than the three-way one the v1 PRD assumed.
